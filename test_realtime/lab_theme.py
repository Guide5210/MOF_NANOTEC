...
SERIES = [
    ...
    "#7A5A87",   # (เสนอเป็น UI_SERIES_4) ม่วง
]
...
UI_CONFIG_FILE = os.path.join(BASE_DIR, "ec_ui_config.json")
...
def load_ui_config():
    ...
    try:
        ...
        print("[ui] ec_ui_config.json อ่านไม่ได้ ({}) - ใช้ค่าเริ่มต้น".format(e))
...
def save_ui_config(cfg):
    ...
    try:
        ...
        print("[ui] เขียน ec_ui_config.json ไม่ได้: {}".format(e))
        return False
